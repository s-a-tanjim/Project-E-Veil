        ...
        if(!filter_var($email,FILTER_VALIDATE_EMAIL)){
          ...
          if($resultCheck>0){
            ...
            if(mysqli_query($conn,$sql)){
              ...
              $sql="CREATE TABLE ".$username." ( id INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY, from_ VARCHAR(255) NOT NULL , message VARBINARY(5000) NOT NULL , date DATE NOT NULL DEFAULT CURRENT_TIMESTAMP, mode VARCHAR(20) NOT NULL , bin BOOLEAN NOT NULL DEFAULT FALSE ,  seen BOOLEAN NOT NULL DEFAULT TRUE) ENGINE = InnoDB;";
              if(mysqli_query($conn,$sql)){
